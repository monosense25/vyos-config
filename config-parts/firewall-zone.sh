...
set firewall zone MGMT from WAN firewall name 'WAN-MGMT-v4'
...
set firewall zone HOME from WAN firewall name 'WAN-HOME-v4'
...
set firewall zone INFRA from WAN firewall name 'WAN-INFRA-v4'

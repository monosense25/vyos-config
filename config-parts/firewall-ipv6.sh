...
set firewall ipv6 forward filter rule 131 inbound-interface interface-group 'IG_home'
set firewall ipv6 forward filter rule 131 outbound-interface interface-group 'IG_home'
...
set firewall ipv6 forward filter rule 136 outbound-interface interface-group 'IG_home'
set firewall ipv6 forward filter rule 141 action 'accept'
set firewall ipv6 forward filter rule 141 inbound-interface interface-group 'IG_infra'
set firewall ipv6 forward filter rule 141 outbound-interface interface-group 'IG_infra'
set firewall ipv6 forward filter rule 146 action 'drop'
set firewall ipv6 forward filter rule 146 description 'zone_infra default-action'
set firewall ipv6 forward filter rule 146 outbound-interface interface-group 'IG_infra'
set firewall ipv6 forward filter rule 151 action 'accept'
set firewall ipv6 forward filter rule 151 inbound-interface interface-group 'IG_mgmt'
set firewall ipv6 forward filter rule 151 outbound-interface interface-group 'IG_mgmt'
set firewall ipv6 forward filter rule 156 action 'drop'
set firewall ipv6 forward filter rule 156 description 'zone_mgmt default-action'
set firewall ipv6 forward filter rule 156 outbound-interface interface-group 'IG_mgmt'
set firewall ipv6 forward filter rule 161 action 'accept'
set firewall ipv6 forward filter rule 161 inbound-interface interface-group 'IG_cctv'
set firewall ipv6 forward filter rule 161 outbound-interface interface-group 'IG_cctv'
set firewall ipv6 forward filter rule 166 action 'drop'
set firewall ipv6 forward filter rule 166 description 'zone_cctv default-action'
set firewall ipv6 forward filter rule 166 outbound-interface interface-group 'IG_cctv'

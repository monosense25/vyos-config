...
set firewall ipv4 name iot-infra rule 100 description 'Rule: Accept_nas_smb_from_printers'
...
set firewall ipv4 name iot-infra rule 100 source group address-group 'FW_AG_PRINTER_ADDR'

...
set firewall ipv4 name iot-infra rule 100 destination group address-group 'nas'
...
set firewall ipv4 name iot-infra rule 200 destination group address-group 'k8s_plex'
set firewall ipv4 name iot-infra rule 200 destination port '32400'
set firewall ipv4 name iot-infra rule 200 protocol 'tcp'
set firewall ipv4 name iot-infra rule 200 source group address-group 'plex_clients'
...
set firewall ipv4 name iot-infra rule 300 destination group address-group 'k8s_mqtt'
set firewall ipv4 name iot-infra rule 300 destination port '1883'
set firewall ipv4 name iot-infra rule 300 protocol 'tcp'
set firewall ipv4 name iot-infra rule 300 source group address-group 'mqtt_clients'
set firewall ipv4 name iot-infra rule 400 action 'accept'
set firewall ipv4 name iot-infra rule 400 description 'Rule: accept_k8s_ingress_from_sonos_players'
set firewall ipv4 name iot-infra rule 400 destination group address-group 'k8s_ingress'
set firewall ipv4 name iot-infra rule 400 destination port 'http,https'
set firewall ipv4 name iot-infra rule 400 protocol 'tcp'
set firewall ipv4 name iot-infra rule 400 source group address-group 'sonos_players'
...
set firewall ipv4 name iot-infra rule 410 destination group address-group 'k8s_ingress'
...
set firewall ipv4 name iot-infra rule 410 source group address-group 'k8s_ingress_allowed'

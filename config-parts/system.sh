...
# Vector Aggregator
# set system syslog host 172.16.13.1 facility kern level 'warning'
# set system syslog host 172.16.13.1 protocol 'tcp'
# set system syslog host 172.16.13.1 port '6000'
# set system syslog host 172.16.13.1 format 'octet-counted'

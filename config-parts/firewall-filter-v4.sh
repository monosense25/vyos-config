...
set firewall ipv4 output filter rule 101 jump-target 'VYOS-MGMT-v4'
...
set firewall ipv4 output filter rule 201 jump-target 'VYOS-INFRA-v4'
...
set firewall ipv4 output filter rule 301 jump-target 'VYOS-HOME-v4'
...
set firewall ipv4 output filter rule 401 jump-target 'VYOS-IOT-v4'
...
set firewall ipv4 output filter rule 501 jump-target 'VYOS-CCTV-v4'
...
set firewall ipv4 output filter rule 601 jump-target 'VYOS-CONTAINERS-v4'
...
set firewall ipv4 output filter rule 701 jump-target 'VYOS-WAN-v4'
